...
export default function NecklacesPage() {
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <PageHeader
        subtitle="Elegant Adornments"
        title="Necklaces"
        description="Elevate any ensemble with our exquisite necklaces, from delicate pendants to bold statement pieces."
      />

      <ProductListing category="necklaces" onQuickView={handleQuickView} onAddToCart={handleAddToCart} />
