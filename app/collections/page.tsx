  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <PageHeader
        ...
        description="Explore our complete range of handcrafted jewelry, from timeless classics to contemporary masterpieces."
      />

      <ProductListing onQuickView={handleQuickView} onAddToCart={handleAddToCart} />
